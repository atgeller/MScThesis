...
\begin{abstract}
    ...
    We present an indexed type system, called \name, for WebAssembly that is intended to ensure safety while justifying the static elimination of run-time checks. \\\\
\end{abstract}
