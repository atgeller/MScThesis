...
\begin{definition}{$\embed[e]{e}^{t^{*}}=\mathbluesf{e}$}
    ...
    \begin{mathpar}
        \begin{array}{rcl}
            ...
            &=& \<block>\;
                {\begin{stackTL}
                    (\ti{t_1}{a_1}^{*};\ti{t}{a_3}^{*};(\circ,\ti{t_1}{a_1}^{*},\ti{t}{a_3}^{*})
                    \\\; \rightarrow \ti{t_2}{a_2}^{*};\ti{t}{a_4}^{*};(\circ,\ti{t_2}{a_2}^{*},\ti{t}{a_4}^{*}))
                    \\ \embed[e]{e^{*}}^{t^{*}}
            \end{stackTL}} \\
            && \<nsend>\\
        ...
        \begin{array}{rcl}
            ...
            &=& \<func>\;
                {\begin{stackTL}
                    ...
                    \\\; \rightarrow \ti{t_2}{a_2}^{*};\ti{t_1}{a_3}^{*}\;\ti{t}{a_4}^{*};(\circ,\ti{t_2}{a_2}^{*},\ti{t_1}{a_3}^{*}\ti{t}{a_4}^{*}))
                    \\ t^{*} \embed{e}{e^{*}}^{t_1^{*}\;t^{*}}
                \end{stackTL}} \\
            && \<nsend>\\
        \end{array}
...
\begin{definition}{$\embed[module]{module}^{C}=\mathbluesf{module}$}
    ...
    \begin{mathpar}
        \begin{array}{rcl}
            ...
            &=& \<module> \embed[f]{f^{*}}\; glob^{*}\; \embed[tab]{tab^{?}}^{f^{*}}\; mem^{?} \\
        \end{array}
    \end{mathpar}
\end{definition}
