...
We follow the convention that syntax written in a \tbsf{blue sans serif font} denotes a keyword, while text written in $italics$ represents a metavariable.
...
Finally, setting a local variable consumes a value of the type that is given by looking up the type of the local in the context (\refrule{Wasm-Set-Local}).
