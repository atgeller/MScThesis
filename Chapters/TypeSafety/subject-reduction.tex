    ...
    \item Case: $\<local>_n \{ i;v^{*}_l \} \; v^n \<end> \hookrightarrow_j \; v^n$
        ...
        \begin{itemize}
            ...
            \\ $\land$ $S;C \vdash_j \<local>_n \{ i;v_l^{*} \} \; v^n \<end> : s_1;l_1;g_1;\phi_1 \rightarrow s_2;l_1;g_2;\phi_2$
                ...
                $S;C \vdash_j v^n : \epsilon;l_1;g_3;\phi_1 \rightarrow ti^n;l_1;g_4;\phi_2$ by $const$.

                By $inversion$ and $local-diff-inst$, $g_2 = \ti{t}{a}^{*}$, where $a^{*}$ are fresh.

                $S;C \vdash_j v^n : \epsilon;l_1;g_1;\phi_1 \rightarrow ti^n;l_1;g_2;\phi_2$ by $fresh-globals$.
    ...
    \item Case: $\<local>_n \{ i;v^{*}_l \} \; L^k[v^n \; \<return>] \<end> \hookrightarrow_j \; v^n$
        ...
        \begin{itemize}
            ...
            \\ $\land$ $S;C \vdash_j \<local>_n \{ j;v_l^{*} \} \; L^k[v^n \; \<return>] \<end> : s_1;l_1;g_1;\phi_1 \rightarrow s_2;l_1;g_2;\phi_2$
                ...
                $(\vdash v_l : ti_l;\epsilon;\epsilon;\phi_v)^{*}$\\ $\land$
                $S;C_l \vdash_j L^k[v^n \; \<return>] : \epsilon;ti_l^{*};g_1;\phi_1,\phi_v^{*} \rightarrow ti^n;l_2;g_2;\phi_2$,
                ...
                $S;C_l \vdash_j \<return> : s_3 \; ti^n;l_2;g_2;\phi_3 \rightarrow s_4;l_4;g_4;\phi_4$, and $\phi_3 \implies \phi_2$ because they are premises of $return$ which we have assumed to hold.

                $S;C_l \vdash_j v^n : \epsilon;l_2;g_2;\phi_5 \rightarrow ti^n;l_2;g_2;\phi_3$ by $const$ and $composition$.

                \thought{Maybe this this $inversion$ and $composition$? If it is I think the preconditions would be generic and we would then use $const$ to claim that they're what we're claiming here.}
            ...
            \\ $\land$ $S;C \vdash_j \<local>_n \{ i;v_l^{*} \} \; L^k[v^n \; \<return>] \<end> : s_1;l_1;g_1;\phi_1 \rightarrow s_2;l_1;g_2;\phi_2$
                ...
                $S;(ti^n;l_2;g_4;\phi_2) \vdash_i v_l^{*};L^k[v^n \; \<return>] : \epsilon;\epsilon;g_3;\phi_1 \rightarrow ti^n;l_2;g_2;\phi_2$ because it is a premise of $local-diff-inst$ which we have assumed to hold.

                $(\vdash v_l : ti_l;\epsilon;\epsilon;\phi_v)^{*}$\\ $\land$
                $S;C_l \vdash_i L^k[v^n \; \<return>] : \epsilon;ti_l^{*};g_3;\phi_1,\phi_v^{*} \rightarrow ti^n;l_2;g_4;\phi_2$,
                where $C_l = S_\text{inst}(i),\text{local} \; t_v^{*}, \text{return} \; ti^n;l_2;g_4;\phi_2$.

                $\phi_v^{*} = \circ,(\ti{t}{a},(\<eq> a \; \ti{t}{c}))^{*}$, where $\ti{t}{a}^{*} = ti_l^{*}$, $(t.\<const> c)^{*} = v_l^{*}$ by $admin-const$.

                Because $a^{*}$ are fresh, $\phi_1 \implies \phi_1,(\ti{t}{a},(\<eq> a \; ti{t}{c}))^{*}$.

                $S;C_l \vdash_i L^k[v^n \; \<return>] : \epsilon;ti_l^{*};g_3;\phi_1 \rightarrow ti^n;l_2;g_4;\phi_2$ by $weakening$.

                $S;C_l \vdash_i \<return> : s_3 \; ti^n;l_2;g_4;\phi_3 \rightarrow s_4;l_3;g_5;\phi_4$, and $\phi_3 \implies \phi_2$ because they are premises of $return$ which we have assumed to hold.

                $S;C_l \vdash_i v^n : \epsilon;l_2;g_4;\phi_5 \rightarrow ti^n;l_3;g_5;\phi_3$ by $const$ and $composition$.

                \thought{Same thought as in $i = j$ case.}

                $S;C_l \vdash_i v^n : \epsilon;ti_l^{*};g_3;\phi_1 \rightarrow ti^n;ti_l^{*};g_3;\phi_3$ by (Nested-Type-Preserved).

                $S;C_l \vdash_i v^n : \epsilon;ti_l^{*};g_3;\phi_1 \rightarrow ti^n;ti_l^{*};g_3;\phi_2$ by $subtyping$.

                $S;C \vdash_i v^n : \epsilon;l_1;g_3;\phi_1 \rightarrow ti^n;l_1;g_3;\phi_2$ by $const$.

                By $inversion$ and $local-diff-inst$, $g_2 = \ti{t}{a}^{*}$, where $a^{*}$ are fresh.

                $S;C \vdash_i v^n : \epsilon;l_1;g_1;\phi_1 \rightarrow ti^n;l_1;g_2;\phi_2$ by $fresh-globals$.
