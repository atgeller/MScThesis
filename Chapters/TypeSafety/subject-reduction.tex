...
\begin{itemize}
    ...
    \\ $\land$ $s;\<getglobal> j \hookrightarrow_i s_\text{glob}(i,j)$
        ...
        Since the context globals are never overwritten in the premises of any typing rules, $C_\text{global} = S_\text{inst}(i)_\text{global}$, therefore $t = t_2$.

        \thought{This feels too hand-wavy.}
