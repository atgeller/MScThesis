...
\begin{figure}[h]
    ...
    \begin{mathpar}
        \inferrule[]{ %% state entailment
            ...
            v^{*} = (t_l.\<const> c_l)^{*}\\
            \phi = \circ,\ti{t_l}{a_l}^{*},(\<eq> a_l \; \ti{t_l}{c_l})^{*},\ti{t_g}{a_g}^{*},(\<eq> a_g \; \ti{t_g}{c_g})^{*} \\
        } {
            s;v^{*} \models_i \ti{t_l}{a_l}^{*};\ti{t_g}{a_g};\phi
        } \and
        ...
        \inferrule{ %% admin code
            ...
            S;C \vdash_i s;v^{*};e^{*} : \epsilon;l_1;g_1;\phi_1 \rightarrow ti^n;l_2;g_2;\phi_2
        } {
        ...
        \inferrule[]{ %% local different instance
            S;(ti^n;l_2;g_2;\phi_2) \vdash_i s;v_l^{*};e^{*} : ti^n;l_2;g_2;\phi_2\\
